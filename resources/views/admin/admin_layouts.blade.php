...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{asset('public/backend/node_modules/mdi/css/materialdesignicons.min.css')}}">
  <link rel="stylesheet" href="{{asset('public/backend/node_modules/perfect-scrollbar/dist/css/perfect-scrollbar.min.css')}}">
  <!-- endinject -->
  <!-- plugin css for this page -->
  <link rel="stylesheet" href="{{asset('public/backend/node_modules/rickshaw/rickshaw.min.css')}}" />
  <link rel="stylesheet" href="{{asset('public/backend/bower_components/chartist/dist/chartist.min.css')}}" />
  <!-- End plugin css for this page -->
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.1.0/css/all.css" >
  <!-- inject:css -->
  <link rel="stylesheet" href="{{asset('public/backend/css/style.css')}}">
  <!-- endinject -->
  <link rel="shortcut icon" href="{{asset('public/backend/images/favicon.html')}}" />
</head>
<body class="sidebar-dark">
  ...
  <!-- plugins:js -->
  <script src="{{asset('public/backend/node_modules/jquery/dist/jquery.min.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/popper.js/dist/umd/popper.min.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/bootstrap/dist/js/bootstrap.min.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/perfect-scrollbar/dist/js/perfect-scrollbar.jquery.min.js')}}"></script>
  <!-- endinject -->
  <!-- Plugin js for this page-->
  <script src="{{asset('public/backend/node_modules/flot/jquery.flot.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/flot/jquery.flot.resize.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/flot/jquery.flot.categories.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/flot/jquery.flot.pie.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/rickshaw/vendor/d3.v3.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/rickshaw/rickshaw.min.js')}}"></script>
  <script src="{{asset('public/backend/bower_components/chartist/dist/chartist.min.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/chartist-plugin-legend/chartist-plugin-legend.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/chart.js/dist/Chart.min.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
  ...
  <!-- Plugin js for this page-->
  <script src="{{asset('public/backend/node_modules/datatables.net/js/jquery.dataTables.js')}}"></script>
  <script src="{{asset('public/backend/node_modules/datatables.net-bs4/js/dataTables.bootstrap4.js')}}"></script>
  <!-- Custom js for this page-->
  <script src="{{asset('public/backend/js/dashboard_1.js')}}"></script>
